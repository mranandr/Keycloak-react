 ...
 * the stable Sentry SDK API and can be changed or removed without warning.
 */
export declare function _INTERNAL_captureLog(beforeLog: Log, client?: Client | undefined, scope?: import("..").Scope, captureSerializedLog?: (client: Client, log: SerializedLog) => void): void;
/**
